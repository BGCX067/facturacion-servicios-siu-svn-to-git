 ...
 * @author George
 */
public class PruebaFacturarConsumos {
                ...
                if ((lgCodigoCuentaCobro != null) && (lgCodigoCuentaCobro > 0)){                    
                    ...
                    if (strTipoUsuarioConsumo.equals("UI")){
                       ...
                       try{                            
                            ...
                            new GIDaoException("Se generó un error al enviar la notificación de facturación al usuario " + strUsuarioConsumo, e);
                        }
                    }                    
                }
