 ...
 * @author Jorge.correa
 */
public class DescuentoConsumoXTipoUsuarioDAOImpl extends JDBCConnectionPool implements DescuentoConsumoXTipoUsuarioDAO{
    
    private static final String OBTENER_TODOS = "SELECT * FROM facturacion_servicios.tbl_descuentos_consumos_x_tipos_usuarios ORDER BY intCodigo";
    private static final String OBTENER_UNO = "SELECT * FROM facturacion_servicios.tbl_descuentos_consumos_x_tipos_usuarios WHERE intCodigo = ?";
    private static final String OBTENER_POR_CONSUMO = "SELECT * FROM facturacion_servicios.tbl_descuentos_consumos_x_tipos_usuarios WHERE intConsumo = ?";
    private static final String INSERTAR = "INSERT INTO facturacion_servicios.tbl_descuentos_consumos_x_tipos_usuarios(intConsumo,ftValorDescuento,txtSeFactura,txtUsuarioRegistra,dtFechaRegistra,txtAplicado,dtFechaAplicacion,txtConcepto) VALUES(?,?,?,?,?,?,?,?)";
    private static final String ACTUALIZAR = "UPDATE facturacion_servicios.tbl_descuentos_consumos_x_tipos_usuarios set intConsumo=?,ftValorDescuento=?,txtSeFactura=?,txtUsuarioRegistra=?,dtFechaRegistra=?,txtAplicado=?,dtFechaAplicacion=?,txtConcepto=? WHERE intCodigo=?";
    private static final String ELIMINAR = "DELETE FROM facturacion_servicios.tbl_descuentos_consumos_x_tipos_usuarios WHERE intCodigo = ?";
