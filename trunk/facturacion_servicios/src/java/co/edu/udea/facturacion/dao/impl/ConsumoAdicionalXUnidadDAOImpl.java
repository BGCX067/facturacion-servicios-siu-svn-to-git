 ...
 * @author Jorge.correa
 */
public class ConsumoAdicionalXUnidadDAOImpl extends JDBCConnectionPool implements ConsumoAdicionalXUnidadDAO{
    
    private static final String OBTENER_TODOS = "SELECT * FROM facturacion_servicios.tbl_consumos_adicionales_x_unidades ORDER BY intCodigo";
    private static final String OBTENER_UNO = "SELECT * FROM facturacion_servicios.tbl_consumos_adicionales_x_unidades WHERE intCodigo = ?";
    private static final String OBTENER_POR_CONSUMO = "SELECT * FROM facturacion_servicios.tbl_consumos_adicionales_x_unidades WHERE intConsumo = ?";
    private static final String INSERTAR = "INSERT INTO facturacion_servicios.tbl_consumos_adicionales_x_unidades(intConsumo,txtItem,dtFechaConsumo,intValorUnidad,txtSeFactura,txtUsuarioRegistra,dtFechaRegistra,txtFacturado,dtFechaFacturacion) VALUES(?,?,?,?,?,?,?,?,?)";
    private static final String ACTUALIZAR = "UPDATE facturacion_servicios.tbl_consumos_adicionales_x_unidades set intConsumo=?,txtItem=?,dtFechaConsumo=?,intValorUnidad=?,txtSeFactura=?,txtUsuarioRegistra=?,dtFechaRegistra=?,txtFacturado=?,dtFechaFacturacion=? WHERE intCodigo=?";
    private static final String ELIMINAR = "DELETE FROM facturacion_servicios.tbl_consumos_adicionales_x_unidades WHERE intCodigo = ?";
